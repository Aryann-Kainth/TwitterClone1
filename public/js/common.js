...
function createPostHtml(postData, largeFont = false) {
    ...
    if (postData.postedBy._id == userLoggedIn._id) {
        ...
        if(postData.pinned===true)
        {
            ...
            pinnedPostText="<i class='fas fa-thumbtack'></i> Pinned Post"
        }
        buttons = `<button data-id="${postData._id}" data-toggle="modal" data-target="${dataTarget}" class='pinButton ${pinnedClass}'><i class='fas fa-thumbtack'></i></button>
                    <button data-id="${postData._id}" data-toggle="modal" data-target="#deletePostModal"><i class='fas fa-trash'></i></button>`;
    }
